---
title: Day of Data Baton Rouge 2026
description: Public event information for Day of Data Baton Rouge 2026.
layout: event
...
preconsIntro: The Friday PreCons are full-day, hands-on workshops hosted at Louisiana Blue (5525 Reitz Ave. Baton Rouge, LA 70809) — the lead-in to the Saturday Day of Data Baton Rouge conference day.
precons:
  - name: Ben Miller
    credential: Microsoft MVP
    photo: precons/ben-miller.jpg
    bio:
    ...
    title: PowerShell DBA Dream dbatools Workshop
    registerUrl: https://www.eventbrite.com/e/powershell-dba-dream-dbatools-workshop-tickets-1991071667957?aff=oddtdtcreator
    description:
      - This full-day, hands-on class will guide you through the most essential commands in the dbatools PowerShell module — the toolkit that revolutionizes SQL Server administration. You'll learn how to automate daily DBA tasks, streamline your workflow, and confidently manage SQL environments using PowerShell.
  ...
  - name: Daryl Roberts
    credential: AI Engineer & Educator
    photo: precons/daryl-roberts.png
    bio:
    ...
    title: "AI for the Rest of Us: Vibe Coding & Building MCP Servers with FastMCP"
    registerUrl: https://www.eventbrite.com/e/ai-for-the-rest-of-us-vibe-coding-building-mcp-servers-with-fastmcp-tickets-1991280533680?aff=oddtdtcreator
    description:
    ...
    sections:
      ...
      - heading: What to Bring (Prerequisites)
        items:
...
Day of Data Baton Rouge is a **free, all-day event** hosted by the Baton Rouge User Groups. It offers IT and Microsoft Data Platform professionals, students, and tech enthusiasts the chance to grow their Business Intelligence, Analytics, Azure SQL, and SQL Server skills through expert-led technical training sessions, career development insights, and networking. This community-driven event promotes learning, growth, and connection within the IT community in Baton Rouge.

### Why Attend?

This is a great opportunity to learn from SQL Server Experts, Microsoft MVPs, SQL Server Authors, and Professionals who have been through and can relate to the daily obstacles you face. This one-day training event is unlike any other, providing food, training, and networking.
